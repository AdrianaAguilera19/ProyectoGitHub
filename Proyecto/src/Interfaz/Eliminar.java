...
public class Eliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextoEliminar.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        TextoEliminar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextoEliminarActionPerformed(evt);
            }
        });
        jPanel1.add(TextoEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 240, -1));
        ...
        jPanel1.add(BotonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, -1, -1));
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        // TODO add your handling code here:
        this.grafo.removeVertex(Integer.parseInt(this.TextoEliminar.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Eliminar(grafo).setVisible(true);
            }
        });
    }
